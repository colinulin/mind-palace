...
- If there is any time constraint, make sure to note that in the summary (Message: "call me Kevin today." Summary: "User wants to be called Kevin today") and set it as short term if the period of time is less than 3 days.
